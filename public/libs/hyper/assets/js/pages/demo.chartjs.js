...
!function ($) {
    ...
    ChartJs.prototype.initCharts = function () {
            ...
            var lineOpts = {
                ...
                tension: 0.3, scales: {
                    x: {
                        ...
                        ticks: {
                            stepSize: 20
                        }, display: true, borderDash: [5, 5], grid: {
        ...
        if ($('#bar-chart-example').length > 0) {
            ...
            var barOpts = {
                maintainAspectRatio: false, // barThickness: 'flex',
                barPercentage: 0.7, categoryPercentage: 0.4, // barSpacing: 10,
                plugins: {
                    legend: {
                        display: false
                    },
                    ...
                    y: {
                        grid: {
                            display: false, color: "rgba(0,0,0,0.05)", offset: true,
                        }, stacked: false, ticks: {
                            stepSize: 20
                        }
                    }, x: {
                        dataset: {}, stacked: false, grid: {
        ...
        if ($('#donut-chart-example').length > 0) {
            ...
            var donutOpts = {
                maintainAspectRatio: false, cutoutPercentage: 60, plugins: {
                    legend: {
                        display: false
                    }
                }
